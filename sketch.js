...
function preload(){
  ...
  carrot1=loadImage("assets/carrot.png")
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    if(carrotsGroup.isTouching(kangaroo)){
      score = score + 2;
...
function spawnCarrots() {
  if(frameCount % 595 === 0) {
    ...
    var carrot = createSprite(camera.position.x+400,330,40,40);
    carrot.setCollider("rectangle",0,0,200,200)
